...
# Check if inputs are actually DNA sequences
...
def DNAtoBWT(word):
# transformation from original DNA sequence to Burrows-Wheeler
...
def BWTtoDNA(word):
# inverse transformation from BTW sequence to original DNA
...
# Checks correctness of input file, parses it and creates output
